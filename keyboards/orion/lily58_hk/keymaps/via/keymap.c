 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  LALT(KC_LEFT), KC_Z, LT(_LOWER,KC_X), LT(_RAISE,KC_C), LT(_ADJUST,KC_V),    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    LT(_ADJUST,KC_M), LT(_RAISE,KC_COMM), LT(_LOWER,KC_DOT), KC_SLSH, RALT(KC_LEFT),
